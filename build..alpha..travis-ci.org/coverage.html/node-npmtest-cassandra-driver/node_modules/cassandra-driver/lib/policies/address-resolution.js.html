...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-cassandra-driver/node_modules/cassandra-driver/lib/policies/address-resolution.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-cassandra-driver/node_modules/cassandra-driver/lib/policies/address-resolution.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-cassandra-driver/node_modules/cassandra-driver/lib/policies/</a> &#187; address-resolution.js</div>
</div>
<div class="body">
 ...
 */
AddressTranslator.prototype.translate = <span class="fstat-no" title="function not covered" >function (address, port, callback) {</span>
<span class="cstat-no" title="statement not covered" >  callback(address + ':' + port);</span>
};
&nbsp;
/**
 * @class
 ...
 * @constructor
 */
<span class="fstat-no" title="function not covered" >function EC2MultiRegionTranslator() {</span>
&nbsp;
}
&nbsp;
 ...
 */
EC2MultiRegionTranslator.prototype.translate = <span class="fstat-no" title="function not covered" >function (address, port, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var newAddress = address;</span>
...
<span class="fstat-no" title="function not covered" >    function resolve(next) {</span>
<span class="cstat-no" title="statement not covered" >      dns.reverse(address, <span class="fstat-no" title="function not covered" >function (err, hostNames) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (err) {</span>
<span class="cstat-no" title="statement not covered" >          return next(err);</span>
        }
<span class="cstat-no" title="statement not covered" >        if (!hostNames) {</span>
<span class="cstat-no" title="statement not covered" >          return next();</span>
        }
<span class="cstat-no" title="statement not covered" >        name = hostNames[0];</span>
...
<span class="cstat-no" title="statement not covered" >      dns.lookup(name, <span class="fstat-no" title="function not covered" >function (err, lookupAddress) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (err) {</span>
<span class="cstat-no" title="statement not covered" >          return next(err);</span>
        }
<span class="cstat-no" title="statement not covered" >        newAddress = lookupAddress;</span>
<span class="cstat-no" title="statement not covered" >        next();</span>
      });
    }], <span class="fstat-no" title="function not covered" >function (err) {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
      //there was an issue while doing dns resolution
<span class="cstat-no" title="statement not covered" >      self.logError(address, err);</span>
    }
<span class="cstat-no" title="statement not covered" >    callback(newAddress + ':' + port);</span>
  });
};
&nbsp;
/**
 ...
 * @param {Error} err
 */
EC2MultiRegionTranslator.prototype.logError = <span class="fstat-no" title="function not covered" >function (address, err) {</span>
